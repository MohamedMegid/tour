...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.create') }} {{ trans('backend.city') }}</h1>
    <ol class="breadcrumb">
      ...
      <li class="active"> {{ trans('backend.create') }} {{ trans('backend.city') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-heading">
               <h3 class="panel-title"><i class="livicon" data-name="list" data-size="18" data-c="#fff" data-hc="#fff" data-loop="true"></i> {{ trans('backend.create') }} {{ trans('backend.city') }}</h3>
            </div>
            <div class="panel-body">
                <form action="{{ action('CityController@store') }}" method="POST" role="form">
