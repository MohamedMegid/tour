...
<section class="content-header">
    <h1><i class="livicon" data-name="list" data-size="25" data-c="#418BCA" data-hc="#01BC8C" data-loop="true"></i>{{ trans('backend.create') }} {{ trans('backend.videos') }}</h1>
    <ol class="breadcrumb">
      ...
      <li class="active"> {{ trans('backend.create') }} {{ trans('backend.videos') }}</li>
    </ol>   
</section>
@endsection
     ...
     <div class="col-md-12">
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="{{ action('VideoAlbumController@store') }}" method="POST" role="form">
                        ...
                        @if($Language->all()->count())
                            ...
                            <div id="group-{{$lang->code}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="subject_{{$lang->code}}" value="{{ old('subject_'.$lang->code.'') }}" placeholder="{{ trans('backend.brief') }} @if($Language->all()->count() > '1') {{ $lang->name }} @endif">
                                </div>
